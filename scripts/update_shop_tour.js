...
content = content.replace(
    ...
    `steps={[
              ...
              { element: '.tour-view-details-btn', titleKey: 'view_details_title', descKey: 'view_details_desc', side: 'top', nextRoute: typeof window !== 'undefined' && filteredProducts[0] ? '/' + window.location.pathname.split('/')[1] + '/product/' + filteredProducts[0].id : '/en/shop', mustClick: true }
            ]}`
);

fs.writeFileSync(file, content);
console.log('Updated Shop Tour steps');
